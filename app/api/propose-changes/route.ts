...
- Prefer multi-line find blocks, usually 3-8 lines.
- The find block must be UNIQUE in FILE CONTENT.
...
- Ensure valid JSX.
- Never return zero changes.
- Never return more than one change.
${extraRules || ''}
`.trim();
