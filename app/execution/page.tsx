  ...
  >
    Complete task
      ...
      {tasks.map((task) => {
        ...
        return (
          <div key={task.id} className={`mb-10 border-8 p-10 rounded-lg bg-gray-800 ${task.status === 'in_progress' ? 'border-yellow-400 bg-yellow-900' : 'border-gray-600'} space-y-4 border border-gray-500`}>
